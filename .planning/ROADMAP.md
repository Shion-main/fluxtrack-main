...
- [ ] **Phase 04.2: Co-Scheduled Session Attendance** (INSERTED) - Attendance handling for one instructor teaching 2+ sections at the same time in different rooms (129 slots, 54/200 profs): a single scan/verification must cover the co-scheduled sibling sessions so the sweep never falsely marks them Absent (verification 2026-07-07: gaps_found — criterion #3 online merge coverage 104/152; see 04.2-VERIFICATION.md)
